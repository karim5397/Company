...
<!-- ======= Hero Section Slider ======= -->
@include('layouts.website body.slider')
<!-- End Hero  Slider -->
@section('content')
    ...
    <section id="portfolio" class="portfolio">
      <div class="container">
        ...
        <div class="row portfolio-container" data-aos="fade-up">
            ...
            @forelse ($multipics as $pic )

            <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                <img src="{{$pic->image}}" class="img-fluid" alt="">
                <div class="portfolio-info">
                  <h4>App 1</h4>
                  <p>App</p>
                  <a href="{{$pic->image}}" data-gall="portfolioGallery" class="venobox preview-link" title="App 1"><i class="bx bx-plus"></i></a>
        ...
        <div class="row no-gutters clients-wrap clearfix" data-aos="fade-up">
            ...
            <div class="col-lg-3 col-md-4 col-6">
                <div class="client-logo">
                  <img src="{{$brand->brand_image}}" class="img-fluid" style="width: 100%; height:100%;">
                </div>
              </div>
            @empty
            <div class="col-lg-3 col-md-4 col-6">
